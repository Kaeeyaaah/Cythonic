...
public sealed class LexerTests
{
    ...
    public void Lex_SampleProgramMatchesExpectedTokens()
    {
        ...
        var expected = new[]
        {
            ...
            new TokenExpectation(TokenType.DELIMITER, "(", 6, 8, "("),
            new TokenExpectation(TokenType.IDENTIFIER, "count", 6, 9, "COUNT"),
            new TokenExpectation(TokenType.OPERATOR, ">=", 6, 15, ">="),
            new TokenExpectation(TokenType.NUMBER, "11", 6, 18, "11"),
            new TokenExpectation(TokenType.DELIMITER, ")", 6, 20, ")"),
            new TokenExpectation(TokenType.DELIMITER, "{", 6, 22, "{"),
            new TokenExpectation(TokenType.IDENTIFIER, "print", 7, 9, "print"),
            new TokenExpectation(TokenType.DELIMITER, "(", 7, 14, "("),
